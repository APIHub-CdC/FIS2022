...
public class RequestDatosGenerales {
  ...
  @ApiModelProperty(example = "GAGP851231HDFRNC05", required = true, value = "CURP")
  ...
  @ApiModelProperty(example = "1029563672", required = true, value = "Folio Otorgante")
  ...
  public String toString() {
    ...
    sb.append("    colonia: ").append(toIndentedString(coloniaPoblacion)).append("\n");
